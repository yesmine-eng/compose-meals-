...
const containers = document.querySelectorAll('.drop_box')
...
function Composer() {
  return (
  <div>
    <div class="all-page-title page-breadcrumb" class='drop_box'>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6 special-grid dinner">
                    <div class="gallery-single fix" class="draggable" draggable="true">
                      ...
                      <span class="caption"> <h4>Groats</h4>
              ...
              <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6 special-grid lunch">
                    <div class="gallery-single fix" class="draggable" draggable="true">
                      <img src={img13}  class="img-fluid" alt="Image"></img>
                      <span class="caption"><h4>Potatos</h4>
                        <p>Cooked, rich in vitamin C , potassium, primarly carbs, protein and fiber.</p>
                        <h5>1.2DT</h5>
                        </span>
                    </div>
              ...
              <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                <div class="row">
                  <div class="col-lg-4 col-md-6 special-grid dinner">
                    <div class="gallery-single fix" class="draggable" draggable="true">
                      <img src={img21}  class="img-fluid" alt="Image"></img>
                      <span class="caption"> <h4>Pasta</h4>
                        <p>Rich in carbs, Iron. with small amount of calcium, potassium and fat</p>
                        <h5>0.8DT</h5>
                        </span>
                    </div>
